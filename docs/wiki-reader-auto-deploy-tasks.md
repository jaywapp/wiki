...
| 21 | 저장소 시크릿 `VERCEL_TOKEN`·`VERCEL_ORG_ID`·`VERCEL_PROJECT_ID` 삭제, Vercel 토큰 revoke | 사용자 | - | low | 16 | - | - | `gh secret list`, Vercel 토큰 목록 | 시크릿 삭제 done (2026-09-19 사용자 실행, Actions 시크릿 0개 확인). 토큰 revoke todo (사용자가 Vercel 대시보드에서 실행) |
